...
export default function VideoSection() {
    ...
    if (loading) {
        return (
            <div className="snap-section flex h-screen items-center justify-center">
    ...
    return (
        <div className="snap-section flex flex-col items-center justify-center min-h-screen py-8 relative bg-gray-850">
